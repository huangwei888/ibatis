...
public class UserMapperTest {
    ...
    public void testQueryUserById() {
        System.out.println(this.userMapper.queryUserById((long) 1));
    }
    ...
    public void testCache() {
        System.out.println(this.userMapper.queryUserById(Long.valueOf("1")));

        sqlSession.close();
        SqlSession sqlSession = sqlSessionFactory.openSession();
        UserMapper mapper = sqlSession.getMapper(UserMapper.class);

        System.out.println(mapper.queryUserById(Long.valueOf("1")));
    }
